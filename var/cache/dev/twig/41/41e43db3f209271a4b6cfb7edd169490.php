...
class __TwigTemplate_eb54d131752c2a14b39e5dac888513ed extends Template
{
    private $source;
    private $macros = [];
    ...
    <ul>
        ...
        <li>Adresse : ";
        // line 10
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 10, $this->source); })()), "user", [], "any", false, false, false, 10), "adresse", [], "any", false, false, false, 10), "html", null, true);
        echo "</li>
        <li>Ville : ";
        // line 11
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 11, $this->source); })()), "user", [], "any", false, false, false, 11), "ville", [], "any", false, false, false, 11), "html", null, true);
        echo "</li>
        <li>Pays : ";
        // line 12
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 12, $this->source); })()), "user", [], "any", false, false, false, 12), "pays", [], "any", false, false, false, 12), "html", null, true);
        echo "</li>
        <li>Id : ";
        // line 13
...
{% block body %}
    <h1>Profil</h1>
    <p>Bienvenue, {{ app.user.firstname }} {{ app.user.username }} !</p>
    <ul>
