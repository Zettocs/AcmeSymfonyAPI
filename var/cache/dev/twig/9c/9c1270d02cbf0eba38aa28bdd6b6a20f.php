...
<form method=\"POST\" action=\"";
    ...
    <input type=\"hidden\" name=\"prix\" value=\"";
        ...
        echo "\">
    <button type=\"submit\" class=\"afficher-article\" name=\"ajouter_au_panier\">
        Ajouter au panier
    </button>
</form>
...
";
        ...
        if (array_key_exists("message", $context)) {
            ...
            echo twig_escape_filter($this->env, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 135, $this->source); })()), "html", null, true);
            echo "</div>
";
        }
        // line 137
...
";
    ...
    {
        return array (  234 => 137,  228 => 135,  226 => 134,  216 => 127,  212 => 126,  208 => 125,  204 => 124,  199 => 122,  194 => 120,  188 => 117,  180 => 114,  68 => 4,  58 => 3,  35 => 1,);
    }
...
<form method=\"POST\" action=\"{{ path('panier') }}\">
...
{% endblock %}
", "accueil_shop/produit_detail.html.twig", "C:\\EPSI Projet\\Symfony\\AcmeSymfonyAPI\\templates\\accueil_shop\\produit_detail.html.twig");
    }
}
